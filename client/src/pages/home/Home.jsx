  ...
  return (
    <main>
      ...
      <section className="bg-[#E5EDFF] ">
        <div className="mx-auto py-5 px-4 min-h-[450px] max-w-[600px] flex flex-col justify-end items-center">
          <div className="space-y-3">
            <h1 className="text-4xl font-bold text-center md:text-4xl">
              Welcome to
            </h1>
            <h1 className="text-6xl font-bold md:text-7xl text-[#FF5703]">
              Clinicare
            </h1>
          </div>
          <p className="text-zinc-800 text-center mt-5 text-xl lg:text-[22px] lg:w-[767px]">
        ...
        <div className="">
          <div className="mx-auto flex justify-center px-4 md:h-[500px] md:w-[867px] mt-10">
            <img
              src="\public\ipadHospitalHero-img.png"
              alt="hospitalHero-img"
      ...
      <section className="container mx-auto my-10 py-5 px-8">
        <div className="space-y-3 flex flex-col items-center">
          <div className="space-y-4 pt-6 pb-5">
            <h1 className="text-2xl font-bold md:text-3xl text-center lg:text-[36px] text-[#130A5C]">
              Key Features to Simplify Hospital Management
            </h1>
            <p className="text-center md:text-[22px] md:w-[853px]">
        ...
        <div className="grid grid-cols-12 gap-4 lg:gap-8 mt-8 ">
          <div className="col-span-12 md:col-span-4 bg-white rounded-lg flex flex-col items-start justify-center border-[0.2px] border-gray-500 p-4 h-[250px] shadow-lg">
            <div className="w-[300px] pl-2">
              <div className="py-4">
                <RiCalendarScheduleLine
                  size={40}
                  className="text-blue-500 p-1.5 bg-[#D5E2FF] rounded-full"
                />
              </div>
          ...
          <div className="col-span-12 md:col-span-4 bg-white rounded-lg flex flex-col items-start justify-center border-[0.2px] border-gray-500 p-4 h-[250px] shadow-lg">
            <div className="w-[300px] pl-2">
              <div className="py-4 ">
                <RiUserHeartLine
                  size={40}
                  className="text-[#F805F8] bg-[#FFD7FF] rounded-full p-1.5"
                />
              </div>
              <h2 className="text-[24px] font-semibold mb-2">
          ...
          <div className="col-span-12 md:col-span-4 bg-white rounded-lg flex flex-col items-start justify-center border-[0.2px] border-gray-500 p-4 h-[250px] shadow-lg">
            <div className="w-[300px] pl-2 ">
              ...
              <h2 className="text-[24px] font-semibold mb-2 md:w-[330px]">
      ...
      <section className="container mx-auto py-5 px-4 my-14" id="features">
       <div className="space-y-3 flex flex-col items-center">
         <div className="space-y-4">
          <h1 className="text-2xl font-bold text-center md:text-3xl  text-[#130A5C]" id="#how-it-works">
          How It Works
        </h1>
        <p className=" md:text-[22px] md:w-[726px] text-center">
        ...
        <div className="grid grid-cols-12 gap-4 lg:gap-8 mt-8">
          <div className="col-span-12 md:col-span-6 rounded-lg flex flex-col items-center justify-center border-[0.2px] border-gray-500 h-[250px] text-center shadow-lg bg-white">
            <h2 className="text-xl font-bold mb-2">Hospital Operations</h2>
            <p className="text-zinc-800 mb-4">
              Streamline daily operations, resource allocation, and staff
              management.
            </p>
          </div>
          <div className="col-span-12 md:col-span-6 rounded-lg flex flex-col items-center justify-center border-[0.2px] border-gray-500 h-[250px] text-center shadow-lg bg-white">
      ...
      <section className="mx-auto py-5 px-4 md:h-[600px] w-[90%] mt-10">
        <img
          src="/public/clinicare-dashboard.png"
          alt="clinicareDashboard-img"
          className="w-full h-full border-[0.2px] border-gray-500 rounded-lg shadow-lg"
        />
      </section>
