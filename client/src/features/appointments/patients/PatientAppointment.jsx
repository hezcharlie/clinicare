...
const PatientAppTable = lazy(() => import("./PatientAppTable"));
...
export default function PatientsAppointment() {
 ...
 const { isPending, isError, data, error } = useQuery({
    queryKey: ["getAllAppointments", page, limit, query,  startDate, endDate],
  ...
  const patientsAppointment = data?.data?.data?.patientsAppointment || [];
