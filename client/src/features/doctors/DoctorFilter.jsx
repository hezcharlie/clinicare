    ...
    <>
      ...
      >
        <div
          tabIndex={0}
          role="button"
          className="btn m-1 border border-gray-300 bg-white"
        >
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col gap-2 space-y-4">
                ...
                >
                  ...
                  {[ "Cardiology", "Dermatology", "Gastroenterology", "Neurology", "Orthopedics", "Pediatrics", "Psychiatry", "Urology",]?.map((item, index) => (
                    <option key={index} value={item}>
                      {item}
                    </option>
                  ))}
                ...
                >
                  ...
                  {["available", "unavailable", "on leave", "sick"]?.map((item, index) => (
                    <option key={index} value={item}>
                      {item}
                    </option>
                  ))}
