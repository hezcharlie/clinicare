...
//   }, [item, setValue]);
  ...
  return (
    <>
     <button className="btn bg-red-500  text-white max-w-18 h-9" onClick={() => setIsOpen(true)}>
            Delete
          </button>
      <Modal
        isOpen={isOpen}
        id="deleteUserModal"
        classname="bg-white rounded-xl shadow-lg w-[90%] max-w-[400px] mx-auto"
      >
        ...
        {success ? (
         ...
         <div className="p-4 text-center">
          ...
          <div className="flex flex-col items-center gap-2 w-full">
            <RiDeleteBinLine
              size={40}
              className="text-red-500 p-2 border-[0.2px] rounded-full border-red-500rounded-full shadow-lg"
            />
            <h1 className="text-2xl font-bold">Confirm Delete</h1>
            <p>
              Are you sure you want to delete <b>{item?.fullname} account?</b>
            </p>
